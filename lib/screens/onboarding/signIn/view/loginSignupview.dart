        ...
        children: [
           ...
           InkWell(
             ...
             child: Container(
               ...
               // ),
               child:  Text(
                controller.islogin.value?'NEED AN ACCOUNT?': 'HAVE AN ACCOUNT?',
                 style: const TextStyle(
                   color: Colors.white,
                   fontSize: 16,
                   fontWeight: FontWeight.w600,
          ...
          !controller.islogin.value? SignUp():
           Login()
      ...
      child: Column(
        children: [
          CustomTextField(
               ...
               CustomTextField(
                ...
                suffixIcon: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Image.asset(!passShow.value?"assets/images/Eye.png":"assets/images/ClosedEye.png",color: kWhiteColor,height: 5,),
                  )),
                validator: (value){
             ...
             controller.isLoading.value?loader: DefaultButton(
                width: w, 
                height: h*0.065, 
                text: "SIGN UP", 
                press: ()async{
                  ...
                  controller.isLoading.value = true;
                   await controller.register(controller.first.text, controller.last.text, controller.mail.text, controller.pass.text);
        ...
        children: [
          ...
          const Center(
           ...
           Container(
             ...
             // ),
             child:    Text(
              'We sent a verification code to \n'.toUpperCase()+controller.otpemail.value,
              textAlign: TextAlign.center,
               style: const TextStyle(
                 color: Colors.white,
                 fontSize: 16,
