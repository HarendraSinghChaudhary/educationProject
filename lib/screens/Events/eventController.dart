...
try {
  var request =await http.post(
    ...
    "powerHourId":selectedID.value
      ...
      if(request.statusCode==200){
         if(json["status"]){
          powerHours.value!.upcoming![selectedIndex.value].is_user_attending = true;
          int value = int.parse(selectcount.value)+1;
          selectcount.value = value.toString();
          powerHours.value!.upcoming![selectedIndex.value].attendees_count = value;
