                ...
                child: Stack(
                  children: [
                    Align(
                      ...
                      child: Header(des: "", heading: "", image: ""),
                    ),
                    Align(
                        ...
                        child: Column(
                          children: [
                            Container(
                                ...
                                child: CustomYoutubeBuilder(
                                  url: controller.data.value!.video.toString(),
                                )),
                            ListTile(
                              contentPadding:
                          ...
                          children: [
                            Text(
                              controller.convertdate(
                                  controller.data.value!.startTime!),
                              style: const TextStyle(
                            ...
                            Visibility(
                              ...
                              child: controller.data.value!.startTime!
                                      .toLocal()
                                      .isBefore(controller.currentdate)
                                  ? Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: w * 0.15,
                                          vertical: h * 0.01),
                                      child: JoinButton(
                                          controller.data.value!.joinUrl),
                                    )
                                  : Padding(
                                      padding: EdgeInsets.symmetric(
                                          horizontal: w * 0.15,
                                      ...
                                      child: AddtoCalender(
                                        starttime: controller
                                            ...
                                            .toLocal(),
                                        endtime: controller.data.value!.endTime!
                                            .toLocal(),
                                        title: controller
                                            .data.value!.powerHoursTitle
                                            .toString(),
                                        des: controller.data.value!.joinUrl
                                            .toString(),
                                      ),
                                    ),
                            ),
...
class AddtoCalender extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton(
      onPressed: () {
        addtoCalendar(starttime, endtime, title, des);
      },
      style: TextButton.styleFrom(
          primary: kPrimaryColor,
          elevation: 2,
...
class _CurrentEventView2State extends State<CurrentEventView2> {
  ...
  String urlid = "";
  CurrentEventController controller = Get.put<CurrentEventController>(
                            ...
                            child: Column(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Text(
                                    // "Influencer 101: Growing to 100K Followers",
                                    controller.data.value!.powerHoursTitle
                                        .toString(),
                                    textAlign: TextAlign.center,
                                    style: const TextStyle(
                                        fontSize: 24,
                                ...
                                Visibility(
                                  visible: Get.find<EventController>()
                                      .showyoutube
                                      .value,
                                  child: Column(
                                    children: [
