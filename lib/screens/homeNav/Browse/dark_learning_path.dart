...
class DarkLearningBinding implements Bindings {
  ...
  DarkLearningBinding(
      {required this.courseListbyLearningPath,
      required this.description,
      required this.image,
      required this.title});
  @override
  void dependencies() {
    Get.lazyPut<DarkLearningPathController>(() => DarkLearningPathController(
          courseListbyLearningPath: courseListbyLearningPath,
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          Container(
            padding:
                EdgeInsets.only(left: w * 0.08, right: w * 0.08, top: h * 0.06),
            height: h * 0.25,
            width: w,
                ...
                children: [
                  ...
                  Expanded(
                    child: TabBarView(children: [
                      Learn(
                        list: controller.courseListbyLearningPath,
                      ),
                      const Build()
                    ]),
                  )
      ...
      children: List.generate(
          ...
          (index) => InkWell(
                onTap: () {
                  ...
                  Get.to(
                    () => DarkCourseDetail(),
                    binding: DarkCourseDetailBinding(
              ...
              SliverToBoxAdapter(
                child: Column(
                  children: [
                            ...
                            child: InkWell(
                              ...
                              child: Center(
                                child: Text(
                                  "LEARN",
                                  style: TextStyle(
                                      color: controller.islearn.value
                                          ? kPrimaryColor
                                          : kWhiteColor),
                                ),
                              ),
                    ...
                    Visibility(
                        visible: controller.islearn.value,
                        child: Learn(
                          list: controller.courseListbyLearningPath,
                        )),
                    Visibility(
