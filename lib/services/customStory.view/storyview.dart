import 'package:Ambitious/screens/homeNav/Browse/flash_card.dart';
...
import '../../screens/homeNav/Browse/quiz_end.dart';
...
class CustomCourseView extends StatefulWidget {
  ...
  final String title;
  // final int a,r,g,b;
  const CustomCourseView({Key? key, required this.study, required this.title})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(
          change_to_a(widget.study[currentIndex].a!.toInt()),
          widget.study[currentIndex].r!.toInt(),
          widget.study[currentIndex].g!.toInt(),
          widget.study[currentIndex].b!.toInt()),
                        ...
                        child: Center(
                          ...
                          child: Column(
                            children: [
                              HtmlView(
                                  text: widget
                                      .study[currentIndex].StudayMaterial
                                      .toString()),
                              Visibility(
                                visible: widget.study[currentIndex].image !=
                                        "" &&
                                    widget.study[currentIndex].image != null &&
                                    widget.study[currentIndex].image != "null",
                                child: Column(
                                  children: [
                                    SizedBox(
                                    ...
                                    ClipRRect(
                                      ...
                                      child: Image.network(
                                        widget.study[currentIndex].image
                                            .toString(),
                                        errorBuilder:
                              ...
                              Visibility(
                                visible: widget
                                            .study[currentIndex].youtubeUrl !=
                                        null &&
                                    widget.study[currentIndex].youtubeUrl !=
                                        "null" &&
                                    widget.study[currentIndex].youtubeUrl != "",
                                child: Column(
                                  children: [
                      ...
                      (index) => Expanded(
                            ...
                            decoration: BoxDecoration(
                                color: index <= currentIndex
                                    ...
                                    : kstatusgreyColor,
                                borderRadius:
                                    BorderRadius.circular(h * 0.0025)),
                            margin: EdgeInsets.symmetric(horizontal: w * 0.001),
                          ))),
                ),
              ),
            ),
                  ...
                  child: GestureDetector(
                    onTap: () {
                      if (currentIndex == maxlength - 1) {
                        Get.off(() => LessonEnd(), binding: LessonEndBinding());
                      }
