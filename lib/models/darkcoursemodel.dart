...
DarkCourseDetailModel darkCourseDetailModelFromJson(String str) =>
    DarkCourseDetailModel.fromJson(json.decode(str));

String darkCourseDetailModelToJson(DarkCourseDetailModel data) =>
...
class DarkCourseDetailModel {
  ...
  factory DarkCourseDetailModel.fromJson(Map<String, dynamic> json) =>
      DarkCourseDetailModel(
        id: json["_id"],
        title: json["title"],
        ...
        allmodule: List<Allmodule>.from(
            json["allmodule"].map((x) => Allmodule.fromJson(x))),
      );
